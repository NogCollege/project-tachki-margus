        ...
        <div class="wrapper-adv_instr">
            <div class="advertising-page">
                ...
                <div class="widget-adv">
                    ...
                    <div class="adv-slide">
                        <img src="templates/img/photoshoot.png" alt="" class="img-slideAdv">
                        <div class="subblock-slideAdv">
                            <div>
                            ...
                            <a href="#" class="arrow-linkAdv"><img src="templates/img/arrow-advSlide.png" alt="" class="img-arrowLinkAdv"></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="instruction-page">
                ...
                <div class="widget-instr">
                    <div class="instr-slide">
                        <div class="icon-instrSlide"><img src="templates/img/decor.png" alt=""></div>
                    ...
                    <div class="instr-slide">
                        <div class="icon-instrSlide"><img src="templates/img/agreement.png" alt=""></div>
                        <div class="inf-instrSlide">
                    ...
                    <div class="instr-slide">
                        <div class="icon-instrSlide"><img src="templates/img/receiving.png" alt=""></div>
                        <div class="inf-instrSlide">
