<footer class="footer-page">
    <div class="wrapper-footer">
        <div class="link-footer">
            ...
            <div class="subblockLink-footer">
                ...
                <div class="adress_mail-footer">
                    <div><a href="#" class="adress-footer"><img src="templates/img/location.png" alt="">г. Ногинск, ул. Ремесленная,<br class='display_none'> д. 1178А</a></div>
        ...
        <div class="menu-footer">
            ...
            <div class="hr_menu-footer display_block"></div>
